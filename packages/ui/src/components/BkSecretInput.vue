    ...
    <div v-else class="flex items-center gap-2">
      <div class="relative flex-1">
        <input
          ...
          :disabled="disabled"
          class="flex h-9 w-full rounded-lg border border-border bg-background px-3 py-2 pr-10 text-sm text-foreground transition-colors placeholder:text-muted-foreground focus-visible:outline-none focus-visible:border-border-strong disabled:cursor-not-allowed disabled:opacity-50"
          @keydown="onKeydown"
